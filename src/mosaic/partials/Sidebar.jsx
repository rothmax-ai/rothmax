...
export default function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  /* -----------------------------
     MOBILE ONLY: close on outside click
  ----------------------------- */
  useEffect(() => {
    function handleClick(e) {
      const isDesktop = window.innerWidth >= 1024;
      if (isDesktop) return; // desktop NEVER closes by outside-click
      if (!sidebarOpen) return;

      if (!sidebarRef.current) return;
      if (!sidebarRef.current.contains(e.target)) {
        setSidebarOpen(false); // fully close on mobile
      }
    }
  ...
  /* -----------------------------
     WIDTH MODES
  ----------------------------- */
  const expandedWidth = "w-80 lg:w-64";
  const collapsedWidth = "w-18";
      ...
      >
        ...
        {!sidebarOpen && (
          <button
            ...
            className="p-3 mt-4 flex justify-center items-center w-full hover:opacity-80"
          >
            <img src="/rothmax-favicon.png" className="h-8 w-auto mx-auto" />
          </button>
        )}
        ...
        {sidebarOpen && (
          <div className="p-4 overflow-y-auto no-scrollbar flex-1">
            ...
            {/* INPUTS */}
            <section>
              <h3 className="text-xs uppercase text-gray-400 font-semibold pl-1">
                Inputs
              </h3>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                    ...
                    <p className="mt-1 text-sm">
                      ...
                      <span className="font-semibold">
                        ${state.rothConversionAmount.toLocaleString()}
                      </span>
                    </p>
                  </div>
                </li>
            ...
            <section className="mt-6">
              <h3 className="text-xs uppercase text-gray-400 font-semibold mb-2 pl-1">
                Sections
              </h3>
              ...
              <h3 className="text-xs uppercase text-gray-400 font-semibold mb-2 mt-5 pl-1">
                Knowledge
              </h3>
              <ul className="space-y-1 pl-1 text-sm text-gray-700">
