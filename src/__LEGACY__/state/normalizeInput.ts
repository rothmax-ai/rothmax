...
import type { NormalizedInput } from "../engines/types";

// Default normalized engine state
export const defaultInputState: NormalizedInput = {
  agi: 60000,
  filingStatus: "single",
  age: 60,
...
export default function normalizeInput(full: Full1040Input): NormalizedInput {
  return {
