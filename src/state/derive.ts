...
import type { InputValidated } from "./validation";

// -----------------------------------------------
// Numeric cleaners (canonical sanitize helpers)
// -----------------------------------------------
export function cleanNumber(n: unknown): number {
  const v = Number(n);
...
// -----------------------------------------------
export function deriveCleanValues(raw: InputValidated) {
  return {
...
// Derived Ages
// -----------------------------------------------
export function deriveAges(raw: InputValidated) {
...
export function deriveIncome(
  clean: ReturnType<typeof deriveCleanValues>
) {
  const agi =
    clean.cleanWages +
    clean.cleanInterest +
...
// ======================================
export function deriveLTCGHelpers(
  raw: InputValidated,
  derived: { agi: number }
) {
...
// Filing helpers
// -----------------------------------------------
export function deriveFilingHelpers(raw: InputValidated) {
...
// -----------------------------------------------
export function deriveIncomeFlags(clean: ReturnType<typeof deriveCleanValues>) {
  return {
...
// -----------------------------------------------
export function derive(raw: InputValidated) {
