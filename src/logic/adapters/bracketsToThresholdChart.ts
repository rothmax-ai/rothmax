// src/logic/adapters/bracketsToThresholdChart.ts
import type { TaxThresholdChartData } from "../types";
...
export function bracketsToThresholdChart(
  taxableIncome: number,      // already includes the conversion
  brackets: BracketDef[]
): TaxThresholdChartData {
