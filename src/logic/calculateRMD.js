...
export function calculateRMD(input) {
    const { age, iraBalance, rmdStartAge = 73, lifeExpectancy = 90, growthRate = 0.04, currentYear = new Date().getFullYear(), // <-- REQUIRED FIX
     } = input;
    // --- Internal state ---
